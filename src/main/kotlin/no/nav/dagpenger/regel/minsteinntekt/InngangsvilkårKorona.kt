...
internal val koronaOrdinærSiste12Måneder =
    Spesifikasjon<Fakta>(
        ...
        implementasjon = {
            when {
                arbeidsinntektSiste12 >= (grunnbeløp.times(0.75.toBigDecimal())) ->
                    Evaluering.ja(
...
@Suppress("ktlint:standard:max-line-length")
internal val koronaOrdinærSiste36Måneder =
    Spesifikasjon<Fakta>(
        ...
        implementasjon = {
            when {
                arbeidsinntektSiste36 >= (grunnbeløp.times(2.25.toBigDecimal())) ->
                    Evaluering.ja(
...
@Suppress("ktlint:standard:max-line-length")
internal val koronaOrdinærSiste12MånederMedFangstOgFiske =
    Spesifikasjon<Fakta>(
        ...
        implementasjon = {
            when {
                erGyldigFangstOgFisk() && inntektSiste12inkludertFangstOgFiske >= (grunnbeløp.times(0.75.toBigDecimal())) ->
                    Evaluering.ja(
...
@Suppress("ktlint:standard:max-line-length")
internal val koronaOrdinærSiste36MånederMedFangstOgFiske =
    Spesifikasjon<Fakta>(
        ...
        implementasjon = {
            when {
                erGyldigFangstOgFisk() && inntektSiste36inkludertFangstOgFiske >= (grunnbeløp.times(2.25.toBigDecimal())) ->
                    Evaluering.ja(
...
@Suppress("ktlint:standard:max-line-length")
private fun Fakta.koronaFangstOgFiskAvslagBegrunnelse(
